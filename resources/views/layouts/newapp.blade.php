...
<head>
    ...
    <!-- Styles -->
    <link rel="stylesheet" type="text/css" href="/new/css/bootstrap-grid.css" />
    ...
    <link rel="stylesheet" type="text/css" href="/new/css/chosen.css" />
    <link rel="stylesheet" type="text/css" href="/new/css/colors/colors.css" />
...
<body>
    ...
    <div class="page-loading">
        <img src="/new/images/loader.gif" alt="" />
    </div>
    ...
    <div class="theme-layout" id="scrollup">
        ...
        <div class="responsive-header">
            <div class="responsive-menubar">
                <div class="res-logo"><a href="index.html" title=""><img src="/new/images/resource/logo.png" alt="" /></a></div>
                <div class="menu-resaction">
                    <div class="res-openmenu">
                        <img src="/new/images/icon.png" alt="" /> Menu
                    </div>
                    <div class="res-closemenu">
                        <img src="/new/images/icon2.png" alt="" /> Close
                    </div>
                </div>
            </div>
        ...
        <header class="stick-top forsticky">
            <div class="menu-sec">
                <div class="container">
                    <div class="logo">
                        <a href="index.html" title=""><img class="hidesticky" src="/new/images/resource/logo.png" alt="" /><img class="showsticky" src="/new/images/resource/logo10.png" alt="" /></a>
                    </div>
                    <!-- Logo -->
                    <div class="btn-extars">
                        <a href="#" title="" class="post-job-btn"><i class="la la-plus"></i>Post Jobs</a>
                        ...
                        <div class="col-lg-3 column">
                            <div class="widget">
                                <div class="about_widget">
                                    <div class="logo">
                                        <a href="index.html" title=""><img src="/new/images/resource/logo.png" alt="" /></a>
                                    </div>
                                    <span>Collin Street West, Victor 8007, Australia.</span>
                                    <span>+1 246-345-0695</span>
                                    <span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="0d64636b624d67626f65786379236e6260">[email&#160;protected]</a></span>
                                    <div class="social">
                        ...
                        <div class="col-lg-3 column">
                            <div class="widget">
                                <div class="download_widget">
                                    <a href="#" title=""><img src="/new/images/resource/dw1.png" alt="" /></a>
                                    <a href="#" title=""><img src="/new/images/resource/dw2.png" alt="" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
      ...
      <script src="/new/js/modernizr.js" type="text/javascript"></script>
      <script src="/new/js/script.js" type="text/javascript"></script>
      <script src="/new/js/bootstrap.min.js" type="text/javascript"></script>
      <script src="/new/js/wow.min.js" type="text/javascript"></script>
      <script src="/new/js/slick.min.js" type="text/javascript"></script>
      <script src="/new/js/parallax.js" type="text/javascript"></script>
      <script src="/new/js/select-chosen.js" type="text/javascript"></script>
